...
date: 'created on 27 Marts 2026 and updated `r format(Sys.time(), "%d %B, %Y")`'
...
See how that compares to the text in the PDF on Page 40. What has pdftools added and where? the /n has been added where the lines end and commence (changes)
